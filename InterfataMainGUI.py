...
import sys
import calendar
import ClasaDB, ClasaPacienti, ClasaProgramari
...
class ProgramatorGui(object):
    def setupUi(self, Form):
        ...
        self.lineEdit = QtWidgets.QLineEdit(Form)
        self.lineEdit.setGeometry(QtCore.QRect(30, 140, 113, 20))
        self.lineEdit.setObjectName("lineEdit")

        
        '''
        self.lineEdit_2 = QtWidgets.QLineEdit(Form)
        self.lineEdit_2.setGeometry(QtCore.QRect(30, 150, 113, 20))
        self.lineEdit_2.setObjectName("lineEdit_2")
        self.lineEdit_3 = QtWidgets.QLineEdit(Form)
        ...
        self.lineEdit_4 = QtWidgets.QLineEdit(Form)
        self.lineEdit_4.setGeometry(QtCore.QRect(30, 210, 113, 20))
        self.lineEdit_4.setObjectName("lineEdit_4")

        self.lineEdit_5 = QtWidgets.QLineEdit(Form)
        self.lineEdit_5.setGeometry(QtCore.QRect(30, 240, 113, 20))
        self.lineEdit_5.setObjectName("lineEdit_5")
        '''
        ...
        '''
        self.label = QtWidgets.QLabel(Form)
        self.label.setGeometry(QtCore.QRect(160, 140, 80, 13))
        self.label.setObjectName("label")
        ...
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(Form)
        self.label_3.setGeometry(QtCore.QRect(160, 180, 47, 13))
        self.label_3.setObjectName("label_3")
        self.label_4 = QtWidgets.QLabel(Form)
        ...
        self.label_6 = QtWidgets.QLabel(Form)
        self.label_6.setGeometry(QtCore.QRect(160, 210, 47, 13))
        self.label_6.setObjectName("label_6")

        self.label_7 = QtWidgets.QLabel(Form)
        self.label_7.setGeometry(QtCore.QRect(160, 240, 47, 13))
        self.label_7.setObjectName("label_7")
        '''
        ...
        self.label_5 = QtWidgets.QLabel(Form)
        self.label_5.setGeometry(QtCore.QRect(70, 5, 111, 111))
        ...
        self.pushButton.clicked.connect(self.AdaugareProgramareBtnClicked)
        # BUTTON ACTIONS LINK/
    ...
    def retranslateUi(self, Form):
        ...
        self.label_3.setText(_translate("Form", "Ora"))
        self.label_4.setText(_translate("Form", "TextLabel"))
        self.label_6.setText(_translate("Form", "Prenume"))
        self.label_7.setText(_translate("Form", "Nume"))
        '''
        self.pushButton.setText(_translate("Form", "Adaugare Programare"))
    
    def AdaugareProgramareBtnClicked(self):
        ###    
        print("")
        Dialog.show()
